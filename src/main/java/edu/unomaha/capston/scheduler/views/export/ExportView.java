package edu.unomaha.capston.scheduler.views.export;
...
import edu.unomaha.capston.scheduler.data.service.SamplePersonService;
import edu.unomaha.capston.scheduler.views.MainLayout;
...
public class ExportView extends Div {
    ...
    public ExportView(SamplePersonService SamplePersonService) {
        this.samplePersonService = SamplePersonService;
        setSizeFull();
        addClassNames("export-view");
